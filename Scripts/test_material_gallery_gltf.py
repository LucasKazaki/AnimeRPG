...
TESTS=[test_expected_pin_matches_generator,test_exact_check,test_light_intensity_semantics,test_material_binding_semantics,test_uncontracted_material_property_semantics,test_camera_fov_semantics,test_camera_rotation_semantics,test_light_rotation_semantics,test_all_triangle_vertex_normals_semantics,test_station_geometry_sharing_semantics,test_sphere_radius_semantics,test_cube_extent_semantics,test_floor_tangent_handedness,test_floor_tangent_direction_semantics,test_camera_transform_override_semantics,test_light_transform_override_semantics,test_source_status_rejected_by_generator,test_runtime_status_semantics,test_uncontracted_runtime_claim_semantics,test_reject_embedded_texture_or_baked_lighting_path,test_accessor_bounds,test_expected_pin_negative,test_crlf_source_and_pin_portability]
