...
public:
    ...
    float IncomingAttackRemaining() const { return incomingAttackRemaining_; }
    bool HasDefenseCounter() const { return defenseCounterRemaining_ > 0.0f; }
    float DefenseCounterRemaining() const { return defenseCounterRemaining_; }
...
private:
    ...
    float incomingAttackRemaining_{};
    float defenseCounterRemaining_{};
