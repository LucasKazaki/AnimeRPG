...
| Color/value review references | Python standard library PNG generator | `adopted_for_source` | ART-007 generates an eight-role palette card, own-layout neutral 16^3 LUT diagnostic and 16-step value ramp with a pinned manifest and 16 regressions. These are art references, not runtime grading assets. |
